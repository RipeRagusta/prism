...
function updateTime()
{
    ...
    document.getElementById("date").innerHTML = (currentDate.getMonth() + 1).toString().padStart(2, "0") + "/" + currentDate.getDate().toString().padStart(2, "0") + "/" + (currentDate.getFullYear() % 100).toString().padStart(2, "0");
    document.getElementById("time").innerHTML = currentHours.toString().padStart(2, "0") + ":" + currentMinutes.toString().padStart(2, "0") + " " + meridiem;
}
